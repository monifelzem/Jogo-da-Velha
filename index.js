...
// Desabilita uma região do tabuleiro para que não consiga clicar novamente
function disableRegion(element) {
  element.classList.remove("cursor-pointer");
  element.removeEventListener("click", handleBoardClick);
}
// Muda a cor das regiões que o jogador venceu e mostra na tela
...
function handleBoardClick(ev) {
  ...
  // Mostra o lugar clicado com o símbolo do jogador da vez
